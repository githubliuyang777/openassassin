...
usage() {
    echo "Usage: curl -fsSL <url>/install.sh | bash -s -- --token <TOKEN> --server <URL>"
    echo ""
    echo "Required:"
...
echo "Downloading host-agent..."
DOWNLOAD_URL="https://github.com/openassassin/host-agent/releases/latest/download/host-agent-linux-${ARCH}"
